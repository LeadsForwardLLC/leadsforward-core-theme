...
function lf_render_homepage_section(array $section, int $index): void {
	...
	if (!$enabled) {
		...
		if (current_user_can('edit_theme_options')) {
			echo '<div class="lf-inline-section-wrap lf-inline-section-wrap--hidden" data-lf-section-wrap="1" data-lf-context-type="homepage" data-lf-context-id="homepage" data-lf-section-id="' . esc_attr((string) $section_id) . '" data-lf-section-type="' . esc_attr((string) $type) . '" data-lf-section-heading-tag="' . esc_attr($wrap_heading_tag_hp) . '" data-lf-section-visible="0">';
