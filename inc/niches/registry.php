...
function lf_get_niche_registry(): array {
	...
	return [
		...
		'power-washing' => [
			'name'                    => __('Power Washing', 'leadsforward-core'),
			'slug'                    => 'power-washing',
			'services'                => [
				__('Exterior House Cleaning', 'leadsforward-core'),
				__('Roof Cleaning', 'leadsforward-core'),
				__('Driveway & Sidewalk Cleaning', 'leadsforward-core'),
				__('Gutter Cleaning', 'leadsforward-core'),
				__('Paver Cleaning & Sealing', 'leadsforward-core'),
				__('Commercial Power Washing', 'leadsforward-core'),
			],
			'required_pages'          => [],
			'homepage_section_order'  => ['hero', 'trust_reviews', 'service_grid', 'service_areas', 'cta', 'faq_accordion', 'cta', 'map_nap'],
			'section_enabled'         => $default_sections,
			...
			'hero_headline_default'   => __('Power Washing in [Your City]', 'leadsforward-core'),
			'hero_subheadline_default' => __('Soft wash exterior cleaning with fast, reliable service.', 'leadsforward-core'),
			'schema_review_enabled'   => true,
		],
		'general' => [
