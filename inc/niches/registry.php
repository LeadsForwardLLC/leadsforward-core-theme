...
function lf_niche_layout_profiles(): array {
	...
	return [
		'core' => [
			...
			'service_area' => function_exists('lf_sections_default_order') ? lf_sections_default_order('service_area') : ['hero', 'trust_bar', 'benefits', 'content_image_a', 'image_content_b', 'services_offered_here', 'faq_accordion', 'nearby_areas', 'map_nap', 'cta'],
