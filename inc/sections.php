	...
	$sections = [
		...
		'trust_reviews' => [
			...
			'fields' => [
				...
				['key' => 'trust_layout', 'label' => __('Layout', 'leadsforward-core'), 'type' => 'select', 'default' => 'grid', 'options' => [
				...
				['key' => 'trust_show_summary', 'label' => __('Show summary', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_show_stars', 'label' => __('Show stars', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				...
				['key' => 'trust_show_avatars', 'label' => __('Show avatars', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_show_quote_icon', 'label' => __('Show quote icon', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_slider_autoplay', 'label' => __('Slider autoplay', 'leadsforward-core'), 'type' => 'select', 'default' => '0', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_slider_autoplay_delay', 'label' => __('Autoplay delay (seconds)', 'leadsforward-core'), 'type' => 'number', 'default' => '5'],
				...
				['key' => 'trust_slider_items_per_slide', 'label' => __('Items per slide (slider only)', 'leadsforward-core'), 'type' => 'number', 'default' => '3'],
			],
