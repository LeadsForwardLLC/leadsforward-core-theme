	...
	$sections = [
		...
		'trust_reviews' => [
			...
			'fields' => [
				...
				// Layout Settings
				['key' => 'trust_layout', 'label' => __('Layout Style', 'leadsforward-core'), 'type' => 'select', 'default' => 'grid', 'options' => [
					'grid' => __('Grid Layout', 'leadsforward-core'),
					'slider' => __('Slider/Carousel', 'leadsforward-core'),
					'masonry' => __('Masonry Layout', 'leadsforward-core'),
				]],
				['key' => 'trust_columns', 'label' => __('Grid Columns', 'leadsforward-core'), 'type' => 'select', 'default' => '3', 'options' => [
					'2' => __('2 Columns', 'leadsforward-core'),
					'3' => __('3 Columns', 'leadsforward-core'),
					'4' => __('4 Columns', 'leadsforward-core'),
				]],
				['key' => 'trust_max_items', 'label' => __('Number of Reviews to Display', 'leadsforward-core'), 'type' => 'number', 'default' => '12'],
				// Slider Controls (only shown when layout=slider)
				['key' => 'trust_slider_items_per_slide', 'label' => __('Reviews Per Slide (Slider)', 'leadsforward-core'), 'type' => 'number', 'default' => '3'],
				['key' => 'trust_slider_autoplay', 'label' => __('Auto-Play Slider', 'leadsforward-core'), 'type' => 'select', 'default' => '0', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_slider_autoplay_delay', 'label' => __('Auto-Play Delay (seconds)', 'leadsforward-core'), 'type' => 'number', 'default' => '5'],
				['key' => 'trust_slider_show_dots', 'label' => __('Show Slider Dots', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_slider_show_arrows', 'label' => __('Show Slider Arrows', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				// Display Options
				['key' => 'trust_show_summary', 'label' => __('Show Rating Summary', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_show_stars', 'label' => __('Show Star Ratings', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_show_source', 'label' => __('Show Review Source', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_show_avatars', 'label' => __('Show Reviewer Avatars', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
				['key' => 'trust_show_quote_icon', 'label' => __('Show Quote Icons', 'leadsforward-core'), 'type' => 'select', 'default' => '1', 'options' => lf_sections_toggle_options()],
			],
