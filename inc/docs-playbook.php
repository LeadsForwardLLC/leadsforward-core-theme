	...
	?>
			...
			<section id="fleet-updates" class="lf-docs__section">
				...
				<ul>
					...
					<li><?php esc_html_e('Controller download tokens now allow a small multi-fetch window to support legacy WordPress update flows that request the package more than once.', 'leadsforward-core'); ?></li>
