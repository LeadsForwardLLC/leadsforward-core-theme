					...
					<table class="form-table" role="presentation">
						...
						<tr id="lf-business-map-embed">
							...
							<td>
								...
								<p class="description"><?php esc_html_e('Leave this empty to auto-build a map from your address, coordinates, or Google Place ID above (and from your service area / primary city if the address is not set yet). Paste a custom iframe from Google Maps → Share → Embed only when you need to override. No API key is required for the default query-based embed; an optional Maps Embed API key in site settings uses higher-fidelity embed URLs when present. Standard embeds do not include the full Business Profile (stars/reviews) inside the iframe; add your Google Business Profile URL below for review links. The name and address under the map come from NAP, not the iframe.', 'leadsforward-core'); ?></p>
							</td>
						</tr>
						<tr>
