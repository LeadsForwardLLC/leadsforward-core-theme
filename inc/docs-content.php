	...
	<section class="lf-docs" data-lf-docs-root="1">
		...
		<aside class="lf-docs__sidebar" aria-label="<?php esc_attr_e('Documentation navigation', 'leadsforward-core'); ?>">
			...
			<nav class="lf-docs__nav">
				...
				<a href="#writer-workflow"><?php esc_html_e('Writer workflow (fast path)', 'leadsforward-core'); ?></a>
				<a href="#roadmap"><?php esc_html_e('Full launch order', 'leadsforward-core'); ?></a>
				...
				<a href="#import-page-content"><?php esc_html_e('Import Page Content', 'leadsforward-core'); ?></a>
				<a href="#fleet-page-templates"><?php esc_html_e('Fleet page templates', 'leadsforward-core'); ?></a>
				<a href="#header-navigation"><?php esc_html_e('Header navigation', 'leadsforward-core'); ?></a>
				<a href="#airtable-live-sync"><?php esc_html_e('Airtable live sync', 'leadsforward-core'); ?></a>
				...
				<a href="#manifester"><?php esc_html_e('AI Manifester (n8n)', 'leadsforward-core'); ?></a>
