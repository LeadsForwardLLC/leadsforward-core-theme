...
- **AI Assistant (bounded):** Safe edit mode for existing pages plus draft creation modes (new Page, CPT item, Blog Post), with optional uploaded document context (text/docx) for richer prompts
