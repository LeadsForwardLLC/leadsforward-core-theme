> **Active copy.** Promoted from `docs/archive/superpowers/specs/2026-05-06-seo-ai-workflow-hardening-design.md`.  
> Canonical n8n export: `inc/manifester/docs/n8n-workflow.json` (not `docs/n8n-workflow.json`).
...
## Appendix: How `inc/manifester/docs/n8n-workflow.json` generates content (for the team)
